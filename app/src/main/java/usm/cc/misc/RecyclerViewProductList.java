...
public class RecyclerViewProductList extends RecyclerView {
    ...
    /**
     * La primera CardView no es centrada automáticamente al
     * cargar los datos al RecyclerView, así que debemos centrarla
     * nosotros y utilizamos esta variable para indicar si lo hemos hecho.
     */
        ...
        if (enabled) {
            ...
            addOnChildAttachStateChangeListener(new OnChildAttachStateChangeListener() {
                ...
                public void onChildViewAttachedToWindow(View view) {
                    ...
                    // si la primera CardView no ha sido centrada, lo hacemos
                    if (getChildLayoutPosition(view) == 0 && firstChildCentered == false) {
                        scrollToView(getCenterView());
                        firstChildCentered = true;
                    }
                }
    ...
    private void setMarginsForChild(View child) {
        ...
        int startMargin = childIndex == 0 ? (getMeasuredWidth() - child.getMeasuredWidth()) / 2 : 10;
        int endMargin = childIndex == lastItemIndex ? (getMeasuredWidth() - child.getMeasuredWidth()) / 2 : 0;
